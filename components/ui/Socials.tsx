...
// Inline SVGs so we don't pull an icon dependency.
function YouTube() {
  return (
...
export function Socials({ className = "" }: { className?: string }) {
  return (
    <div className={`flex items-center gap-4 ${className}`}>
      <a href={social.youtube} target="_blank" rel="noopener noreferrer" aria-label="YouTube" className="text-red transition-colors hover:text-white">
        <YouTube />
      </a>
      <a href={social.tiktok} target="_blank" rel="noopener noreferrer" aria-label="TikTok" className="text-red transition-colors hover:text-white">
        <TikTok />
      </a>
      <a href={social.instagram} target="_blank" rel="noopener noreferrer" aria-label="Instagram" className="text-red transition-colors hover:text-white">
        <Instagram />
      </a>
    </div>
  );
